...
def sentiment_analysis(text):
    ...
    sen_reponse = client.detect_sentiment(Text=text, LanguageCode = code)
    sentiment = sen_reponse['Sentiment']
    print("The sentiment of the %s text is %s" % (language, sentiment))
    
sentiment_analysis(english)
sentiment_analysis(spanish)
sentiment_analysis(french)
sentiment_analysis(italian)
